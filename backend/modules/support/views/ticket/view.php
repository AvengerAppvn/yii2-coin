...
/** @var \app\modules\ticket\models\TicketBody $newTicket */
/** @var \app\modules\ticket\models\TicketBody $thisTicket */
/** @var \app\modules\ticket\models\TicketFile $fileTicket */
        ...
        <div class="col-lg-12">
            ...
            <?php foreach ($thisTicket as $ticket) : ?>
                ...
                <span><?= $ticket['name_user'] ?>&nbsp;<span
                        style="font-size: 12px">(<?= ($ticket['client'] == 1) ? 'Сотрудник' : 'Client' ?>)</span></span>
