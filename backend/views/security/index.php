...
<div class="col-md-12">
    <div class="panel panel-filled">
        <div class="panel-body">
            ...
            <h4>Security Key: <span style="font-family:Courier;color:#FF4508;letter-spacing:2px;font-size:22px;">QV2IO7IXIAG376IR</span> <small class="text-black"><em>(Time Based Code)</em></small></h4>

            <br>
            <center>
                <img src="<?= Url::to(['qrcode/index', 'v' => 'Hey! This is some content on my QrCode!']) ?>" />
            </center>            
